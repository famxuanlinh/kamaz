        ...
        <div className="row d-flex justify-content-center align-items-center g-0 " style={{ maxHeight: '550px' }}>
            ...
            <div className="col ps-5 " style={{ position: 'relative' }}>
                ...
                <div className="d-flex d-sm-block align-items-center">
                    <div className="text-secondary py-5 w-50">
                        Bất kỳ chiếc xe nào muốn vận hành không gặp sự cố cũng cần được bảo trì thường xuyên
                        <span className="d-xl-none d-xxl-flex">
                            , dịch vụ hướng tới mục đích duy trì khả năng vận hành của tất cả các bộ phận linh kiện trên
                            xe. Việc bảo dưỡng thường xuyên có vai trò vô cùng quan trọng đối với xe tải, vì đây ...
                        </span>
                    </div>
                    <Link className="ms-5 ms-sm-0" to="/sua-chua/bao-tri-bao-duong">
